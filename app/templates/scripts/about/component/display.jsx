     ...
     /*jshint ignore:start */
        <div class="row marketing">
          <div class="col-lg-6">
              ...
              <h4>ReactJS</h4>
              <p>WebComponents as they should be. Lifecycle events rulez.</p>

              <h4>HTML5 Boilerplate</h4>
              <p>The index.html you always wanted.</p>

              <h4>Bootstrap</h4>
              <p>CSS framework for the design-challanged JavaScript deveolpers.</p>
